...
         ]],
      ...
      rq2: ["Vi är inte människor på en själslig resa. Vi är själar på en mänsklig resa.",
            "Lycka är en resa, inte en plats.",
            "Om inte själen arbetar med handen blir det ingen konst.",
            "Du förlorar bara det du fäster dig vid.",
            ...
            "Tro inte att det inte finns några krokodiler bara för att vattnet är lugnt.",
            "Ett väl löddrat skägg är till hälften rakat.",
            "Den som tänker vistas en dag i skogen bör ta med bröd för en vecka.",
            "Ordning är bara för idioter - genier behärskar även kaos.",
            "Andra gången du blir sparkad av en mula lär du dig ingenting.",
            "Vad bryr sig väl örnen vad grodorna kväker om?",
            "Bara med konst kan man uttrycka det man inte begriper",
            "Bättre att leva ett år som tiger än hundra som ett får. -Madonna",
            "Måste du handla, slösa! Måste du tala, snåla!",
            "Den som lever utan galenskap är inte så klok som han tror.",
            "Pipan drar visdom från filosofens läppar och stänger munnen på dåren", 
            "Man skall inte prisa blommorna, förrän frukten kommer."],
